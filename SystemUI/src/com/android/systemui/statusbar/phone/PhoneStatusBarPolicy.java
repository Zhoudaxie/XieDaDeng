...
public class PhoneStatusBarPolicy {
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /* @} */
           /* SPRD: Add for VOLTE {@*/
            else if (action.equals(TelephonyIntents.ACTION_IMS_REGISTRATION)) {
    ...
    public PhoneStatusBarPolicy(Context context, CastController cast, HotspotController hotspot) {
        ...
        // SPRD: Add for VOLTE
        filter.addAction(TelephonyIntents.ACTION_IMS_REGISTRATION);
    ...
    /* @} */
    /* SPRD: Add for update VLOTE Icon {@ */
    private void updateImsRegistration(Intent intent) {
        boolean imsReg = intent.getBooleanExtra("imsReg", false);
        Log.d(TAG, "updateImsRegistration->imsReg  = " + imsReg);
        mService.setIcon("imsreg", R.drawable.stat_sys_volte, 0, null);
        mService.setIconVisibility("imsreg", imsReg);
    }
    /* @} */
}

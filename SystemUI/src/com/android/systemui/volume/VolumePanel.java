 ...
 * @hide
 */
public class VolumePanel extends Handler implements DemoMode,View.OnClickListener {
    ...
    private enum StreamResources {
        ...
        NotificationStream(AudioManager.STREAM_NOTIFICATION,
                ...
                com.android.systemui.R.drawable.ic_notification,
                com.android.systemui.R.drawable.ic_ringer_mute,
                false),
    ...
    public VolumePanel(Context context, ZenModeController zenController) {
		...
		mMoreButton = (ImageView) mView.findViewById(com.android.systemui.R.id.expand_button);
    ...
    private void addOtherVolumes() {
        ...
        for (int i = 0; i < STREAMS.length; i++) {
			...
			android.util.Log.i("sprocomm","(697)STREAMS[i].show="+String.valueOf(STREAMS[i].show)+
				"		streamType= "+streamType+
				"  		mActiveStreamType="+mActiveStreamType);
    ...
    private void expand() {
		...
		android.util.Log.i(TAG,"(708)count=   "+count);
        for (int i = 0; i < count; i++) {
            mSliderPanel.getChildAt(i).setVisibility(View.VISIBLE);
        }
        mMoreButton.setVisibility(View.GONE);
    }
    ...
    private void collapse() {
        ...
        for (int i = 1; i < count; i++) {
            mSliderPanel.getChildAt(i).setVisibility(View.GONE);
        }
    }	
        ...
        if ((flags & AudioManager.FLAG_SHOW_UI) != 0) {
            synchronized (this) {
                if (mActiveStreamType != streamType) {
					android.util.Log.i("sprocomm","(982)streamType="+streamType + "	mActiveStreamType= "+mActiveStreamType);

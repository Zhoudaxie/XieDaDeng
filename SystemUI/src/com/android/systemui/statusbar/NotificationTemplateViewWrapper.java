...
public class NotificationTemplateViewWrapper extends NotificationViewWrapper {
    ...
    private void resolveViews() {
        ...
        /* SPRD: modify bug 432444 mIcon.getDrawable() is null @{
        mIconForceGraysaleWhenDark = mIcon != null && mIcon.getDrawable().getColorFilter() != null;*/
        if(mIcon != null && mIcon.getDrawable() != null && mIcon.getDrawable().getColorFilter() != null){
            mIconForceGraysaleWhenDark = true;
        }else{

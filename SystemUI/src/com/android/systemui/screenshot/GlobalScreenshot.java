...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    public File getStoragePath(){
         ...
         if("mounted".equals(Environment.getExternalStoragePathState())){
             mPath =  new File(Environment.getExternalStorageDirectory(),Environment.DIRECTORY_PICTURES);
		 }
         else{
             mPath =  new File(Environment.getInternalStoragePath(),Environment.DIRECTORY_PICTURES);
		 }
         return new File(mPath,SCREENSHOTS_DIR_NAME);
    }

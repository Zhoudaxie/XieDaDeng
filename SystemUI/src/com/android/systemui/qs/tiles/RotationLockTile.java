...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
    ...
    // SPRD: Bug 431038 - Avoid clicking too frequently.
    ...
    protected void handleClick() {
        if (mController == null || !canClick) return;
        // SPRD: Bug 431038 - Avoid clicking too frequently.
        canClick = false;
        ...
        // SPRD: Bug 431038 - Avoid clicking too frequently.
        clickControllerHandler.sendEmptyMessageDelayed(0, 800);
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (rotationLocked) {
            // SPRD: Bug 428311 - Icon text flashes.
            final int label = portrait ? R.string.quick_settings_rotation_locked_portrait_label
                    : (mController.getAreAllRotationsAllowed() ? R.string.quick_settings_rotation_locked_landscape_label
    ...
    // SPRD: Bug 431038 - Avoid clicking too frequently.
    private Handler clickControllerHandler = new Handler() {

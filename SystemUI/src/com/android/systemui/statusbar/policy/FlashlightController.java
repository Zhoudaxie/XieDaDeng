...
public class FlashlightController {
    ...
    private final String ACTION_FLASHLIGHT_STATE_CLOSED = "android.intent.action.FLASHLIGHT_STATE_CLOSED";
    ...
    public void initialize() {
        ...
        //mFlashLightManager.setUseFlashLightListener(this);
    }
    ...
    private void registerListenerBroadcast(){
    	...
    	filter.addAction(ACTION_FLASHLIGHT_STATE_CLOSED);
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
    	...
    	public void onReceive(Context context, Intent intent) {
    		...
    		if(action.equals(ACTION_FLASHLIGHT_STATE_CLOSED)){
    			synchronized (this) {
    				mFlashlightEnabled = false;
    			}
    			dispatchOff();

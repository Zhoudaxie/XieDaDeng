...
public class KeyguardIndicationController {
    ...
    public KeyguardIndicationController(Context context, KeyguardIndicationTextView textView) {
        ...
        context.registerReceiverAsUser(
                mReceiver, UserHandle.OWNER, filter, null, null);
    }
    ...
    private String computePowerIndication() {
            ...
            if (chargingTimeRemaining > 0) {
				...
				if(mBatteryLevel != -1) {
					return mContext.getResources().getString(
                        R.string.keyguard_indication_charging_time, chargingTimeFormatted) + " (" + mBatteryLevel +"%)";
				}
                return mContext.getResources().getString(
		...
		if(mBatteryLevel != -1) {
			return mContext.getResources().getString(R.string.keyguard_plugged_in) + " (" + mBatteryLevel +"%)";
		}
